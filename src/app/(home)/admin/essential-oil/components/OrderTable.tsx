...
export default function OrderTable() {
    ...
    React.useEffect(() => {
        ...
        const observer = new ResizeObserver(() => {
            ...
            const fixed = colWidths.col1 + colWidths.col3 + colWidths.col5

            setColWidths((prev) => ({
                ...prev,
                col2: (totalWidth - fixed) / 3 * 1,
                col4: (totalWidth - fixed) / 3 * 2,
            }))
        })
    ...
    }, [colWidths.col1, colWidths.col3, colWidths.col5])
        ...
        <React.Fragment>
            ...
            <FormControl size="sm">
                ...
                <Select size="sm" placeholder="All">
                    ...
                    <Option value="refund">Headache</Option>
                    <Option value="purchase">Stomache</Option>
                </Select>
            </FormControl>
        </React.Fragment>
    );
        ...
        <React.Fragment>
            ...
            >
                <FormControl sx={{ flex: 1 }} size="sm">
                    <FormLabel>Search for essential oil</FormLabel>
            ...
            >
                ...
                >
                    <colgroup>
                        <col style={{ width: `${colWidths.col1}px` }} />
                        <col style={{ width: `${colWidths.col2}px` }} />
                        <col style={{ width: `${colWidths.col3}px` }} />
                        <col style={{ width: `${colWidths.col4}px` }} />
                        <col style={{ width: `${colWidths.col5}px` }} />
                    </colgroup>
                    <thead>
                        <tr>
